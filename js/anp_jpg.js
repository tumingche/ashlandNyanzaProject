...
document.addEventListener("touchmove", function(e) {if(e.target.id != "myRange") {e.preventDefault();}}, false);
    ...
    $(document).ready(function(e) {
            ...
            $("#btn_cc_2014_1").on("click", function(){
                ...
                if($(this).is(".active")) {
                   scrollBar.val(7.64);
                   timelineImg_top.attr("src", "img/timeline/12.jpg");
            ...
            */
            ...
            scrollBar.on("input change", function(e) {
                ...
                // var timelineImg_bot = $("#myImg_bot");
                timelineImg_bot.attr("src", "img/timeline/" + ((timelineImg_bot_num * 2 ) - 1) + ".jpg");
                // var timelineImg_top = $("#myImg_top");
                timelineImg_top.attr("src", "img/timeline/" + ((timelineImg_top_num - 1) * 2 ) + ".jpg");
                ...
                if(scrollBar_val >= 7.80) {         
                    timelineImg_bot.attr("src", "img/timeline/13.jpg");
                    timelineImg_top.attr("src", "img/timeline/12.jpg");
                    ...
                    timelineImg_bot.attr("src", "img/timeline/12.jpg");
