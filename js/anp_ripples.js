(function($){
    ...
    $(document).ready(function(e) {
            ...
            /* ////////RIPPLE.JS////////////// */
            var div_cc_2014_1 = $("#div_cc_2014_1");
            var div_cc_2014_2 = $("#div_cc_2014_2");
            var div_cc_2014_3 = $("#div_cc_2014_3");
            var div_cc_2009_1 = $("#div_cc_2009_1");
            var div_cc_2009_2 = $("#div_cc_2009_2");
            var div_cc_2009_3 = $("#div_cc_2009_3");
            var div_cc_2009_4 = $("#div_cc_2009_4");
            var div_cc_2009_5 = $("#div_cc_2009_5");
            var div_cc_2009_6 = $("#div_cc_2009_6");
            var div_cc_2004_1 = $("#div_cc_2004_1");
            var div_cc_1993_1 = $("#div_cc_1993_1");
            var div_cc_1993_2 = $("#div_cc_1993_2");
            var div_cc_1993_3 = $("#div_cc_1993_3");
            var div_cc_1993_4 = $("#div_cc_1993_4");
            var div_cc_1993_5 = $("#div_cc_1993_5");
            var div_cc_1993_6 = $("#div_cc_1993_6");
            div_cc_2014_1.hide();
            div_cc_2014_2.hide();
            div_cc_2014_3.hide();
            div_cc_2009_1.hide();
            ...
            */
            $("#btn_cc_2014_2").on("click", function(){
                ...
                */
                div_cc_2014_2.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_2014_3").on("click", function(){
                ...
                */
                div_cc_2014_3.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_2009_1").on("click", function(){
                ...
                */
                div_cc_2009_1.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_2009_2").on("click", function(){
                ...
                */
                div_cc_2009_2.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_2009_3").on("click", function(){
                ...
                */
                div_cc_2009_3.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_2009_4").on("click", function(){
                ...
                */
                div_cc_2009_4.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_2009_5").on("click", function(){
                ...
                */
                div_cc_2009_5.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_2009_6").on("click", function(){
                ...
                */
                div_cc_2009_6.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_2004_1").on("click", function(){
                ...
                */
                div_cc_2004_1.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_1993_1").on("click", function(){
                ...
                */
                div_cc_1993_1.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_1993_2").on("click", function(){
                ...
                */
                div_cc_1993_2.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_1993_3").on("click", function(){
                ...
                */
                div_cc_1993_3.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_1993_4").on("click", function(){
                ...
                */
                div_cc_1993_4.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_1993_5").on("click", function(){
                ...
                */
                div_cc_1993_5.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
            ...
            $("#btn_cc_1993_6").on("click", function(){
                ...
                */
                div_cc_1993_6.fadeToggle("fast", function() {
                     $(this).ripples({
                        resolution: 256,
                        dropRadius: 10, //px
                        perturbance: 0.04,
